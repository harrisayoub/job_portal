			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					@if (!auth()->check())
						...
						<li><a href="{{ lurl(trans('routes.register')) }}"><i class="icon-user-add fa"></i> {{ t('Sign Up') }}</a></li>
					@else
						<li>
        ...
        <nav class="navbar navbar-default navbar-custom">
            <div class="container">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{ lurl(trans('routes.v-search', $attr), $attr) }}">{{ t('Browse Jobs') }}</a></li>
                    <li><a href="{{ lurl('page/news') }}">{{ t('News') }}</a></li>
                    <li><a href="#">{{ t('Geddit! Magazine') }}</a></li>
                    <li><a href="#">{{ t('Murdoch University Home') }}</a></li>
                </ul>
            </div>
        </nav>
    </div>
