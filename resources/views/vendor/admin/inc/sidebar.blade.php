	...
	<aside class="main-sidebar" id="adminSidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					<a href="#"><i class="fa fa-table"></i><span>{{ trans('admin::messages.jobs') }}</span><i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						...
						<li><a href="{{ admin_url('p_types') }}"><i class="fa fa-cog"></i> <span>{{ trans('admin::messages.job types') }}</span></a></li>
						@endif
                ...
                @endif
				<li><a href="{{ admin_url('news') }}"><i class="fa fa-clone"></i> <span>{{ trans('admin::messages.news') }}</span></a></li>                
				{!! $pluginsMenu !!}
