		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 page-content">
					<div class="inner-box">
						<h2 class="title-2">
							<i class="icon-mail"></i> {{ t('Applied Jobs') }}
						</h2>
							...
							<form name="listForm" method="POST" action="{{ lurl('account/'.$pagePath.'/delete') }}">
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									<tr>
										...
										<th style="width:88%" data-sort-ignore="true">{{ t('Applied Jobs') }}</th>
									...
									<tr>
										...
										<td>
											<div style="word-break:break-all;">
												...
												@endif
												<br>
												<strong>{{ t('For Post') }}:</strong>&nbsp;{{ $conversation->subject }}<br>
												<strong>{{ t('Applied By') }}:</strong>&nbsp;{{ str_limit($conversation->from_name, 50) }}
												...
												<a href="{{ lurl('account/conversations/' . $conversation->id . '/messages') }}">
													{{ t('Click here to read the application') }}
												</a>
											</div>
										</td>
										<td class="action-td">
